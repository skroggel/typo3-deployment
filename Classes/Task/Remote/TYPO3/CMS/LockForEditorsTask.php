 ...
 */
class LockForEditorsTask extends AbstractCliTask
{
    ...
    {
        return [$this->getTypo3ConsoleScriptFileName($node, $application, $deployment, $options), 'backend:lockforeditors'];
    }
